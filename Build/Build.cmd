...
Set BuildCmd=%VS120COMNTOOLS%..\IDE\devenv.com
...
"%~dp0%ToolsDir%\xlZip.exe" /z "%~dp0%ReleaseDir%\Win32\*" "%~dp0%ReleaseDir%\%AppName%_%Version%_Win32_ForWin81.zip" /utf8
...
"%~dp0%ToolsDir%\xlZip.exe" /z "%~dp0%ReleaseDir%\x64\*" "%~dp0%ReleaseDir%\%AppName%_%Version%_x64_ForWin81.zip" /utf8
