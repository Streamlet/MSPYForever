...
#define XL_TYPELIST_TYPENAME_DECLARE(n)         XL_REPZ_COMMA(XL_TYPELIST_TYPENAME_DECLARE_PATTERN, n)
#define XL_TYPELIST_TYPENAME_LIST_PATTERN(n)    T##n
#define XL_TYPELIST_TYPENAME_LIST(n)            XL_REPZ_COMMA(XL_TYPELIST_TYPENAME_LIST_PATTERN,    n)
