...
#define XL_FUNCTION_TYPENAME_DECLARE(n)             XL_REPZ_COMMA(XL_FUNCTION_TYPENAME_DECLARE_PATTERN, n)

#define XL_FUNCTION_TYPENAME_LIST_PATTERN(n)        A##n
#define XL_FUNCTION_TYPENAME_LIST(n)                XL_REPZ_COMMA(XL_FUNCTION_TYPENAME_LIST_PATTERN, n)

#define XL_FUNCTION_TYPENAME_VARIABLE_PATTERN(n)    A##n a##n
#define XL_FUNCTION_TYPENAME_VARIABLE(n)            XL_REPZ_COMMA(XL_FUNCTION_TYPENAME_VARIABLE_PATTERN, n)

#define XL_FUNCTION_VARIABLE_LIST_PATTERN(n)        static_cast<A##n &&>(a##n)
#define XL_FUNCTION_VARIABLE_LIST(n)                XL_REPZ_COMMA(XL_FUNCTION_VARIABLE_LIST_PATTERN, n)
