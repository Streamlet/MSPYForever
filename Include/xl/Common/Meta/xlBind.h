...
#define XL_BIND_TYPENAME_DECLARE(n)             XL_REPZ_COMMA(XL_BIND_TYPENAME_DECLARE_PATTERN, n)

#define XL_BIND_TYPENAME_DECLARE_PATTERN_B(n)   typename B##n
#define XL_BIND_TYPENAME_DECLARE_B(n)           XL_REPZ_COMMA(XL_BIND_TYPENAME_DECLARE_PATTERN_B, n)

#define XL_BIND_TYPENAME_LIST_PATTERN(n)        A##n
#define XL_BIND_TYPENAME_LIST(n)                XL_REPZ_COMMA(XL_BIND_TYPENAME_LIST_PATTERN, n)

#define XL_BIND_TYPENAME_LIST_PATTERN_B(n)      B##n
#define XL_BIND_TYPENAME_LIST_B(n)              XL_REPZ_COMMA(XL_BIND_TYPENAME_LIST_PATTERN_B, n)

#define XL_BIND_TYPENAME_VARIABLE_NO_RREF(n)    A##n a##n
#define XL_BIND_TYPENAME_VARIABLE_PATTERN(n)    A##n &&a##n
#define XL_BIND_TYPENAME_VARIABLE(n)            XL_REPZ_COMMA(XL_BIND_TYPENAME_VARIABLE_PATTERN, n)

#define XL_BIND_VARIABLE_INITIALIZE_PATTERN(n)  a##n(static_cast<A##n &&>(a##n))
#define XL_BIND_VARIABLE_INITIALIZE(n)          XL_REPZ_COMMA(XL_BIND_VARIABLE_INITIALIZE_PATTERN, n)

#define XL_BIND_VARIABLE_LIST_PATTERN(n)        static_cast<A##n &&>(a##n)
#define XL_BIND_VARIABLE_LIST(n)                XL_REPZ_COMMA(XL_BIND_VARIABLE_LIST_PATTERN, n)

#define XL_BIND_ARGUMENTS_QUERY_PATTERN(n)      a[static_cast<A##n &&>(a##n)]
#define XL_BIND_ARGUMENTS_QUERY(n)              XL_REPZ_COMMA(XL_BIND_ARGUMENTS_QUERY_PATTERN, n)
